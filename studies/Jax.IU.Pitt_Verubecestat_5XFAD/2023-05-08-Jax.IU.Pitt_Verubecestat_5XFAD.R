...
grant <- "U54AG054345"
consortium <- "MODEL-AD"
study_name <- "Jax.IU.Pitt_Verubecestat_5XFAD"
version <- "2023-05-08"
...
# 2. add organ and tissue annotations to all the files -- especially with the pk data, it seems like some of it was plasma and some of it was brain
 
results %>% 
  filter(str_detect(name, "Lev"))
